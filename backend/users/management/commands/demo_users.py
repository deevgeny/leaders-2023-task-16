...
demo_users = [
    {"email": "candidate@mail.ru", "password": "123456", "role": "CANDIDATE",
     "first_name": "Иван", "surname": "Иванович", "last_name": "Иванов",
     "phone": "+79990001122"},
    {"email": "intern@mail.ru", "password": "123456", "role": "INTERN",
     "first_name": "Иван", "surname": "Иванович", "last_name": "Иванов",
     "phone": "+79991112233"},
    {"email": "mentor@mail.ru", "password": "123456", "role": "MENTOR",
     "first_name": "Иван", "surname": "Иванович", "last_name": "Иванов",
     "phone": "+79992223344"}, 
     {"email": "curator@mail.ru", "password": "123456", "role": "CURATOR",
     "first_name": "Иван", "surname": "Иванович", "last_name": "Иванов",
     "phone": "+79993334455"},
    {"email": "staff@mail.ru", "password": "123456", "role": "STAFF",
     "first_name": "Иван", "surname": "Иванович", "last_name": "Иванов",
     "phone": "+79994445566"},
]
...
user_data = {"email": "candidate_{}@mail.ru", "password": "123456",
           "role": "CANDIDATE", "first_name": "Имя", "surname": "Фамилия",
           "last_name": "Отчество", "phone": "+7800{}",
           "gender": ["MALE", "FEMALE"], "city": "Москва",
           "district": ["ЦАО", "САО", "СВАО", "ЮВАО", "ЮАО", "ЮЗАО", "ЗАО",
                        "СЗАО", "ЗелАО", "ТиНАО"],
            "education_institution": ["Учебное заведение №1",
                                      "Учебное заведение №2",
                                      "Учебное заведение №3"],
            "education_city": "Москва", "faculty": "Факультет",
            "speciality": ["Специальность 1", "Специальность 2",
                           "Специальность 3", "Специальность 4"],
            "graduation_year": [2024, 2025, 2023, 2026, 2027],
            "education_level": ["Специалист", "Магистр", "Бакалавр"],
            "job_experience": ["Описание опыта 1", "Описание опыта 2",
                               "Описание опыта 3", "Описание опыта 4"],
